"""
Django settings for PassStore project.
...
SECRET_KEY = 'django-insecure-=znhqrb=^zjq1z)l++n_(76&)_ih#1(jy&==v^m+1zy5)c$5$0'
...
WSGI_APPLICATION = 'PassStore.wsgi.application'
